...
struct IOEvent
{
    ...
    // EVENT --> has a start time, the length it will block a process, and a unique ID, 
    //           and indicate when a process should be blocked

    // INTERRUPT --> has a unique event ID and a unique process ID, 
    //               and indicate when a process should go from blocked --> running
